...
function showAreaData(areaConfig) {
	var areaName = areaConfig.hover;
	document.getElementById("customModalLabel").innerText = areaName;
...
function tryaddEvent(id, relationId) {
    ...
    if (tryjsconfig[id].active === !0) {
        ...
        _Textobj.mouseup(function () {
            ...
            }else if (tryjsconfig[id].target === "custom") {
				showAreaData(tryjsconfig[id]);
			}
        });
